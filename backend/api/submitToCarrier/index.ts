...
import { orchestrateCarrierSubmission } from "../src/services/submissionOrchestrator";
...
app.http("submitToCarrier", {
  methods: ["POST"],
  authLevel: "anonymous",
  route: "submission/carrier/submit",
  handler: submitToCarrierHandler,
});
