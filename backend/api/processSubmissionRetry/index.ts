...
import { loadQueuedSubmission, moveSubmissionToDeadLetter } from "../src/services/retryQueue";
import { submitCarrierPayload } from "../src/services/carrierApiClient";
import { updateSubmissionStatus } from "../src/services/submissionStatusStore";
...
app.http("processSubmissionRetry", {
  methods: ["POST"],
  authLevel: "anonymous",
  route: "submission/retry/process",
  handler: processSubmissionRetryHandler,
});
