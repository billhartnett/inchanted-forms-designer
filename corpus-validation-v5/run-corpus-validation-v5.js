...
function main() {
  ...
  const validationReport = {
    schemaVersion: 'corpus-validation-v5.v1',
    generatedAt: new Date().toISOString(),
    repositoryRoot: repoRoot,
    source: {
      engine: 'semantic-engine-v2',
      patchSet: 'residual-rule-synthesis-v5',
  ...
  const outputRoot = path.join(repoRoot, 'corpus-validation-v5');
  ...
  const snapshotManifest = {
    schemaVersion: 'corpus-validation-v5-snapshots.v1',
    generatedAt: new Date().toISOString(),
